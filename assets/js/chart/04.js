...
$(function() {
  $(document).ready(function() {
    ...
    var chart32 = new Highcharts.Chart('3-2', {
      chart: { type: config['3-2'].type },
      title: { text: config['3-2'].question },
      xAxis: xAxis,
    ...
    var chart42 = new Highcharts.Chart('4-2', {
      chart: { type: config['4-2'].type },
      title: { text: config['4-2'].question },
      xAxis: xAxis,
    ...
    var chart43 = new Highcharts.Chart('4-3', {
      chart: { type: config['4-3'].type },
      title: { text: config['4-3'].question },
      xAxis: xAxis,
    ...
    var chart44 = new Highcharts.Chart('4-4', {
      chart: { type: config['4-4'].type },
      title: { text: config['4-4'].question },
      xAxis: xAxis,
    ...
    var chart52 = new Highcharts.Chart('5-2', {
      chart: { type: config['5-2'].type },
      title: { text: config['5-2'].question },
      xAxis: xAxis,
